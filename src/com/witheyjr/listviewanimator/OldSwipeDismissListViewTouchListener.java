 ...
 */
@SuppressLint("NewApi")
public class OldSwipeDismissListViewTouchListener implements View.OnTouchListener {
     ...
     */
    public OldSwipeDismissListViewTouchListener(ListView listView, DismissCallbacks callbacks) {
